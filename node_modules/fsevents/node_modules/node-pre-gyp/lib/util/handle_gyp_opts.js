...
node-pre-gyp and node-gyp (e.g. see the difference between "dist" and "rebuild" below)
...
`npm install --dist-from-source` will give:

argv == [ 'rebuild' ]
gyp.opts.argv == { remain: [ 'install' ],
  cooked: [ 'install', '--fallback-to-dist' ],
  original: [ 'install', '--fallback-to-dist' ] }

`./bin/node-pre-gyp dist` will give:

argv == []
gyp.opts.argv == { remain: [ 'dist' ],
  cooked: [ 'dist' ],
  original: [ '-C', 'test/app1', 'dist' ] }
